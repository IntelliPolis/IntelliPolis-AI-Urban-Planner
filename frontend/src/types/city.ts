...
export type FacilityType="HOSPITAL"|"PARK"|"SCHOOL"|"TRANSIT_HUB"|"CULTURE"|"PUBLIC_SERVICE"|"CHILDCARE"|"SENIOR_CARE"|"SPORTS_CENTER"|"LIBRARY"|"GREEN_SHELTER"|"HEALTH_CENTER"|"PARKING";
...
export interface MapCenter { latitude:number; longitude:number; areaM2?:number; activityCount?:number; population?:number }
