...
public final class Enums {
 ...
 public enum FacilityType { HOSPITAL, PARK, SCHOOL, TRANSIT_HUB, CULTURE, PUBLIC_SERVICE, CHILDCARE, SENIOR_CARE, SPORTS_CENTER, LIBRARY, GREEN_SHELTER, HEALTH_CENTER, PARKING }
 public enum RoadType { ROAD, BUS, BRT, SUBWAY, PEDESTRIAN, BICYCLE }
 public enum RoadImprovementType { OPERATION_DIAGNOSIS, SIGNAL_OPTIMIZATION, LANE_OPERATION, PUBLIC_TRANSIT, PEDESTRIAN_SAFETY, DEMAND_MANAGEMENT, EXPANSION_REVIEW, NEW_ROAD_REVIEW }
