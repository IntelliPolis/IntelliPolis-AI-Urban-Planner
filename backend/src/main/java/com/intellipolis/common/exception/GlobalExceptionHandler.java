...
public class GlobalExceptionHandler {
 ...
 @ExceptionHandler({VWorldException.class,UrbanDataException.class,ExternalDataException.class,TrafficDataException.class,SpatialDataException.class}) ResponseEntity<Map<String,Object>> external(RuntimeException e,HttpServletRequest r){return response(503,"Service Unavailable",e.getMessage(),r);}
