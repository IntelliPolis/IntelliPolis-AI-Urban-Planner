...
class CityScoreCalculatorTest {
 ...
 private CityAnalysisRequest request(){return new CityAnalysisRequest("부산광역시","가상 해안구",320000L,48.5,22.4,14.2,8.1,12,34,8,2.3,1.8,1.1,List.of("중앙로"),100L,List.of("환경"),new MapCoordinate(35.16,129.16),List.of());}
